...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Barang Keluar</a>
            <!-- Sidebar Toggle-->
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-info" name="hapusbarangkeluar">Hapus</button>      
                                                        </div>
                                                    </form>
                                                    </div>
                                                </div>
            ...
            <div class="modal-content">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <input type="text" name="penerima" placeholder="penerima" class="form-control mb-3" require>
                        <input type="text" name="qty" placeholder="Quantity" class="form-control mb-3" require>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-info" name="barangkeluar">Simpan</button>      
                    </div>
                </form>
            </div>
        </div>
